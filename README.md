...
A sample Twig template is included in [App/Views/Home/index.html](App/Views/Home/en_index.twig) that inherits from the base template in [App/Views/base.html](App/Views/en_base.twig).
